...
{% include figure.html path="assets/img/cwsi_analytic.png" class="img-fluid z-depth-1" %}
...
{% include figure.html path="assets/img/wref_kibler_eb_test.png" class="img-fluid z-depth-1" %}
